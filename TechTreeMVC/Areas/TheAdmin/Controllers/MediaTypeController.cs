...
namespace TechTreeMVC.Areas.TheAdmin.Controllers
{
    ...
    public class MediaTypeController : Controller
    {
        ...
        // GET: TheAdmin/MediaType/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: TheAdmin/MediaType/Create
        ...
        // POST: TheAdmin/MediaType/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to.
        // For more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: TheAdmin/MediaType/Delete/5
        ...
        // POST: TheAdmin/MediaType/Delete/5

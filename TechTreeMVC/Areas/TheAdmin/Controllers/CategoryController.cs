...
namespace TechTreeMVC.Areas.TheAdmin.Controllers
{
    ...
    public class CategoryController : Controller
    {
        ...
        // GET: TheAdmin/Category
        public async Task<IActionResult> Index()
        {
            return View(await _context.Categories.ToListAsync());
        }

        // GET: TheAdmin/Category/Details/5
        ...
        // GET: TheAdmin/Category/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: TheAdmin/Category/Create
        ...
        // GET: TheAdmin/Category/Delete/5
        ...
        // POST: TheAdmin/Category/Delete/5

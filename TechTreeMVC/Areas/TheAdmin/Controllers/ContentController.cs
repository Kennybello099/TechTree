...
namespace TechTreeMVC.Areas.TheAdmin.Controllers
{
    ...
    public class ContentController : Controller
    {
        ...
        //We deleted other action method cos we dont need them, they are redundant
        // GET: TheAdmin/Content/Create
